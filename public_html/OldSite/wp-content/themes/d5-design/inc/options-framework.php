...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		...
		$of_page = add_theme_page('Design Theme option',  'Design Theme option',  'edit_theme_options', 'options-framework','optionsframework_page');
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
	    ...
	    <div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submit">
				...
				<input type="submit" class="reset-button button-secondary" name="reset" value="Restore Defaults" onclick="return confirm( '<?php print 'Click OK to reset. Any theme settings will be lost!'; ?>' );" />
