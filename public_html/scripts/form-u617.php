...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U645"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>About You:</b></td><td>' . htmlentities($_REQUEST["custom_U624"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Other Comments:</b></td><td>' . htmlentities($_REQUEST["custom_U656"],ENT_COMPAT,'UTF-8') . '</td></tr>';
